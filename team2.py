...
def TEAM2():
    for player in name:
        if player[-1:] == '*':
            ...
            # print(tpoints)
            team2TestPoints.append(tpoints)
            ...
            # print(T20points)
            team2T20Points.append(T20points)
    ...
    # print(team2PLAYER)
    # print(team2TestPoints)
    # print(team2ODIPoints)
    # print(team2T20Points)
